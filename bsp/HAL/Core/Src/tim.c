...
static void pwm_advanced_init(TIM_HandleTypeDef *htim, TIM_TypeDef *instance) {
...
void MX_TIM1_Init(void) { pwm_advanced_init(&htim1, TIM1); }
void MX_TIM8_Init(void) { pwm_advanced_init(&htim8, TIM8); }
